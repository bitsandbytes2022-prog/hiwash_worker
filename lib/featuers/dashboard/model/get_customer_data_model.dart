...
class Data {
  ...
  Data({this.customerDetails, this.subscriptionDetails, this.offerDetails});
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    offerDetails = json['offerDetails'] != null
        ? new OfferDetails.fromJson(json['offerDetails'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.offerDetails != null) {
      data['offerDetails'] = this.offerDetails!.toJson();
    }
    return data;
  }
}
